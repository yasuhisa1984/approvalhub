  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">承認ルート設定</h2>
...
function RouteCreateForm({ onClose, onSave }: RouteCreateFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-bold text-gray-900">新規承認ルート</h3>
        <button
          onClick={onClose}
          ...
          <div className="flex items-center gap-2 overflow-x-auto">
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center gap-2">
                <div className="px-4 py-2 bg-white border border-primary-300 rounded-lg text-sm font-medium text-gray-700 whitespace-nowrap">
                  {step.approverName}
                </div>
